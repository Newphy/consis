...
public final class UniqueId implements Comparable<UniqueId>, Serializable {
     ...
     * @since 2.12.0
     */
    public static UniqueId createFromLegacyFormat(final int time, final int machine, final int inc) {
        return new UniqueId(time, machine, inc);
    }
     ...
     * @param date the date
     */
    public UniqueId(final Date date) {
     ...
     */
    public UniqueId(final Date date, final int counter) {
     ...
     */
    public UniqueId(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public UniqueId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(timestamp, machineIdentifier, processIdentifier, counter, true);
    }

    private UniqueId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter,
     ...
     */
    public UniqueId(final String hexString) {
     ...
     */
    UniqueId(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
